...
tags: [valvular-heart-disease, aortic-regurgitation]
source_count: 1
...
- Acute AR: usually infective endocarditis or aortic dissection — requires urgent surgical assessment [[sources/vhd-esc-2025]] `very high`
...
- Aortic phenotype (root vs ascending vs mixed) determines suitability for VSARR or AV repair [[sources/vhd-esc-2025]] `very high`
...
- No medical therapy has been shown to delay surgery in asymptomatic AR [[sources/vhd-esc-2025]] `very high`
...
- **Class IIb (new 2025):**
  ...
  - TAVI for symptomatic severe AR in patients ineligible for surgery if anatomy suitable [[sources/vhd-esc-2025]] `very high`
...
- **TAVI for AR (Class IIb, new 2025):** off-label non-dedicated devices carry ~10% risk of second valve/surgical conversion; dedicated TAVI devices reduce migration and residual AR but associated with high pacemaker rate (~24%) [[sources/vhd-esc-2025]] `very high`
...
- Marfan syndrome and connective tissue disease: lifelong surveillance after repair for residual aortic segments; screen first-degree relatives [[sources/vhd-esc-2025]] `very high`
...
- Ascending aorta >45 mm: confirm with CCT/CMR at baseline, repeat TTE at 6 months, then yearly; CT/CMR if increase >3 mm [[sources/vhd-esc-2025]] `very high`
