...
- Three main clinical scenarios:
  1. **CSP anti-bradycardia pacing** (replacing standard RV pacing)
  2. **CSP-CRT** (CSP replacing biventricular pacing for cardiac resynchronization)
  3. **HOT-CRT / LOT-CRT** (His-optimized or LBB-optimized CRT: CSP combined with LV lead) [[sources/csp-ehra-2023]] 
