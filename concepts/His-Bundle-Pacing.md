...
### Electrical Targets
- Optimal threshold: ≤1.5 V/0.5 ms; acceptable up to 2.0–2.5 V@0.5 ms in HF/CRT scenarios
- In patients with long HV or HV block: demonstrate 1:1 conduction at cycle lengths ≤400 ms at working output
- Bipolar sensing: ideally >2.0 mV (or unipolar >4 mV)
...
### Back-up Ventricular Lead Indications
...
- 3D electroanatomical mapping useful in challenging anatomy, congenital heart disease, or pregnancy
