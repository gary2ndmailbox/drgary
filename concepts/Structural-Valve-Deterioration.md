...
- **Paravalvular leak (PVL):** More common after TAVI than SAVR; haemolysis and HF if severe; transcatheter closure should be considered for suitable PVLs (Class IIa) [[sources/vhd-esc-2025]] `very high`
