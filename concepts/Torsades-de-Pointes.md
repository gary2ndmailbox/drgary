...
## Definition
Torsades de pointes (TdP) is a polymorphic ventricular tachycardia (VT) characterized by a twisting morphology of the QRS complex around the isoelectric baseline on ECG. It is the hallmark arrhythmia of long QT syndrome and can degenerate into ventricular fibrillation, causing sudden cardiac death.

## Key Concepts
- TdP arises from abnormal prolongation of the cardiac action potential (phase 3 repolarization), creating conditions for early afterdepolarizations that trigger re-entrant arrhythmias. ([[sources/channelopathies-jaha-2025]])
- **Acquired (drug-induced) TdP** is the most common cause of TdP; >200 drugs with TdP potential remain available; TdP can degenerate into VF and cause SCD. Drugs cause TdP primarily through IKr inhibition, prolonging action potential duration and increasing susceptibility to EADs. Some drugs additionally augment late sodium current (INa-L) — dofetilide, ibutilide, d-sotalol, thioridazine, erythromycin. Amiodarone, unlike quinidine/sotalol, does not increase transmural dispersion of repolarization, partly explaining its lower TdP incidence. ([[sources/drug-arrhythmia-aha-2020]], rating: very high)
- **Repolarization reserve theory:** Repolarization is modulated by multiple redundant mechanisms (IKr, IKs, INa-L, etc.). When one mechanism is already perturbed (e.g., by a latent LQTS mutation), the introduction of an IKr-inhibiting drug depletes repolarization reserve, unmasking QT prolongation and TdP risk. This explains why ~30% of drug-induced TdP patients carry pathogenic variants in the 5 major LQTS genes. ([[sources/drug-arrhythmia-aha-2020]])
- **Risk factors for drug-induced TdP:** QTc >500 ms or increase ≥60 ms from baseline; female sex; age >65; bradycardia; acute MI; hypokalaemia; hypomagnesaemia; hypocalcaemia; HFrEF; ≥2 concurrent QT-prolonging drugs; prior drug-induced TdP; pharmacokinetic drug interactions; renal/hepatic impairment with renally/hepatically eliminated drugs. ([[sources/drug-arrhythmia-aha-2020]])
...
- **Latent LQTS prevalence in drug-induced TdP — discrepant estimates:** The AHA 2020 statement reports ~30% of drug-induced QT prolongation patients carry pathogenic variants in 1 of 5 major LQTS genes. The arrhythmia genetics review (2025) cites only 10–15% as representing unmasked hidden LQTS. This discrepancy likely reflects different methodologies, gene panels, and patient populations — it has not been reconciled. Neither figure currently supports routine pre-prescription genetic screening for QT-prolonging drugs. ([[sources/drug-arrhythmia-aha-2020]], [[sources/arrhythmia-genetics-mgenetik-2025]])
- **Sex-based risk — clinical actionability limited:** Estrogen's inhibition of IKr explains higher TdP risk in females aged 18–40. The postpartum period carries particularly elevated risk (2.7-fold cardiac events; 4.1-fold life-threatening events). However, no guideline currently recommends different beta-blocker dosing, QTc monitoring intervals, or ICD thresholds based on sex or hormonal status — the biological explanation has not translated into sex-stratified clinical recommendations. Despite strong preclinical evidence that postpartum progesterone supplementation could be protective in LQT2, no guideline recommends this. ([[sources/channelopathies-jaha-2025]], [[sources/lqts-pregnancy-medicina-2022]])
