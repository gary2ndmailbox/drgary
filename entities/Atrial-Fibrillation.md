...
- **CHA2DS2-VASc likely underestimates** thromboembolic risk in cancer: score = 0 in cancer may not be truly low-risk. Danish registry data: cancer patients with CHA2DS2-VASc 0–1 had higher 2-year stroke risk than non-cancer counterparts. ([[sources/Cardio-Oncology-ESC-2022]])
...
- **NOAC preferred** over LMWH and VKA (Class IIa/B). LMWH preferred over NOACs in: unoperated GI/GU cancer; severe renal dysfunction (CrCl <15 mL/min); platelet count <50,000; major drug interactions.
