...
- SDB (OSA + CSA) is present in **21–74%** of AF patients (vs. 3–49% general population); most AF+OSA patients do not report daytime sleepiness — symptom-based screening is unreliable. ([[sources/sdb-arrhythmia-aha-2022]], rating: very high; [[sources/osa-af-jama-2018]], rating: high)
- Nearly **5-fold higher odds** of AF with moderate-to-severe SDB after adjusting for obesity and cardiovascular risk. ([[sources/sdb-arrhythmia-aha-2022]])
- **Arrhythmogenic substrate:** OSA creates a unique complex and dynamic substrate through dual mechanisms: acute apnea-associated electrophysiological changes (atrial stretch, shortened refractoriness, sympathovagal activation → premature atrial contractions) and long-term structural remodeling (atrial fibrosis, connexin dysregulation, conduction slowing). See [[concepts/OSA-Arrhythmogenic-Substrate]]. ([[sources/osa-af-jama-2018]])
...
- Nocturnal hypoxia (not AHI) predicted incident AF independently (HR 2.47 [95% CI 1.64–3.71]) in 8,256 patients. AHI may be an inferior metric vs. nocturnal hypoxemic burden for predicting AF risk. ([[sources/sdb-arrhythmia-aha-2022]])
...
- **Screening:** Sleep study evaluation is reasonable in AF patients being considered for rhythm control strategy regardless of sleepiness symptoms. Polygraphy is a practical screening modality. AHA 2022 consensus: screen for OSA in AF (obesity, HT, nocturnal AF predominance); treat SDB as part of lifestyle modification; CPAP supported by observational data but not confirmed by RCTs (SAVE, Caples, Traaen). ([[sources/osa-af-jama-2018]]; [[sources/sdb-arrhythmia-aha-2022]])
...
- See [[entities/Obstructive-Sleep-Apnea]] for full detail.

### MASLD and Metabolic Syndrome
- MASLD is associated with ×1.2–1.5 increased long-term risk of atrial fibrillation (updated meta-analysis, Liver Int 2025), sharing metabolic substrate with obesity-related AF (visceral adiposity, insulin resistance, systemic inflammation). ([[sources/masld-nejm-2025]], rating: high)
- The magnitude of MASLD-AF association (×1.2–1.5) is lower than SDB-AF (HR 2.18) and obesity-AF (HR 1.49 per 5-unit BMI increment), suggesting MASLD is a modifiable AF risk marker — particularly relevant in patients presenting with unexplained AF and metabolic syndrome features. ([[sources/masld-nejm-2025]], rating: high)
- Mechanistic pathway: MASLD-driven insulin resistance and visceral adiposity → epicardial adipose tissue expansion → atrial structural and electrical remodeling → AF substrate. MASLD also increases new-onset HF risk ×1.2–1.5 and new-onset T2DM ×2.2, which are themselves independent AF risk factors. ([[sources/masld-nejm-2025]], rating: high)
- See [[entities/MASLD]] for full MASLD epidemiology, CV risk, and pharmacotherapy. GLP-1 receptor agonists (semaglutide, tirzepatide) and SGLT2 inhibitors used for MASLD also reduce AF risk via weight loss and metabolic improvement — see [[entities/Semaglutide]] and [[entities/HFpEF]].
...
- **Opportunistic screening:** Pulse-taking or ECG rhythm strip at every clinical visit is recommended during BTK inhibitor therapy (Class I/C); screen for OSA in all AF patients being considered for rhythm control strategy regardless of symptoms. ([[sources/Cardio-Oncology-ESC-2022]]; [[sources/osa-af-jama-2018]])
- **Wearables/CIEDs:** Device-detected subclinical AF (SCAF/AHREs) requires electrogram review — false-positive AHRE rate ~17% (ASSERT). SCAF detected in 10–50% of CIED populations; carries 2.4× stroke risk. See [[concepts/Subclinical-AF]] for full detail. ([[sources/subclinical-af-aha-2019]], rating: high)
...
- For detailed risk factor data (obesity, SDB/OSA, MASLD, hypertension, drug-induced AF), see **Risk Factors** section above.
...
- **pLAAO:** Class IIa/B-NR (AHA 2023) for patients with contraindication to long-term OAC — upgraded from IIb. ([[sources/AF-AHA-2023]])
  - **CLOSURE-AF (NEJM 2026) — landmark negative trial:** In 888 elderly AF patients at simultaneously high stroke (mean CHA₂DS₂-VASc 5.2) AND high bleeding risk (mean HAS-BLED 3.0; 85% received DOAC in the medical arm), LAAO **failed noninferiority** vs physician-directed best medical care (predominantly DOACs): primary composite (stroke/SE/major bleeding/CV death) 16.8 vs 13.3/100 pt-yr; RMST difference −0.36 years (95% CI −0.70 to −0.01); **P=0.44 for NI**. Stroke was equal (2.6 vs 2.7/100 pt-yr); major bleeding was higher with LAAO (7.4 vs 6.2/100 pt-yr); CV death numerically higher (9.5 vs 7.7/100 pt-yr). The periprocedural + DAPT-driven early bleeding offset the stroke-reduction benefit in this elderly, highest-risk group. This directly challenges the Class IIa recommendation and the rationale for LAAO in the "anticoagulation-unsuitable" high-risk AF population. ([[sources/laao-closureaf-nejm-2026]], rating: very high)
  - **CHAMPION-AF (NEJM 2026) — positive NI trial in NOAC-eligible AF:** In 3,000 patients with AF who were *eligible* for NOAC therapy (mean CHA₂DS₂-VASc 3.5; mean HAS-BLED 1.3; 68.9% paroxysmal; 47.8% prior ablation), Watchman FLX was **noninferior** to NOAC for the primary efficacy composite (CV death/stroke/SE: KM 5.7% vs 4.8%; difference 0.9%; P<0.001 for NI; HR 1.20 [95% CI 0.87–1.66]) and **superior** for non-procedure-related bleeding (KM 10.9% vs 19.0%; HR 0.55 [95% CI 0.45–0.67]; P<0.001). CV death was equal (2.7% vs 2.7%); stroke was numerically higher with LAAO (3.6% vs 2.5%); ischaemic stroke/SE 3.2% vs 2.2%. Net clinical benefit (efficacy + bleeding combined) favoured device (KM 15.1% vs 21.8%; HR 0.66). Post-implant antithrombotic strategy was predominantly NOAC (85%) at discharge — not DAPT — explaining the favourable bleeding profile vs CLOSURE-AF. The key limitation is that the absolute NI margin (4.8 pp) permits up to HR 1.4 for efficacy, and the observed ischaemic stroke excess of ~0.3%/yr may widen at 5-year follow-up. Industry-sponsored (Boston Scientific). ([[sources/laao-championaf-nejm-2026]], rating: very high)
...
### Rhythm Control
- **Early rhythm control:** Implementing rhythm control within 12 months of diagnosis reduces CV death/stroke/HF hospitalisation; Class IIa/B-R (AHA 2023), Class IIa/B (ESC 2024).
- **EAST-AFNET 4** primary result: HR 0.79 (96% CI 0.66–0.94; P=0.005); CV death HR 0.72; stroke HR 0.65; trial stopped early for efficacy at median 5.1 years; benefit independent of symptom status. ([[sources/EAST-AFNET4-NEJM-2020]], rating: very high; [[sources/AF-ESC-2024]]; [[sources/AF-AHA-2023]])
...
- See [[concepts/DAPT-Strategies]] for complete DAPT management framework. See [[entities/Acute-Coronary-Syndrome]] for full ACS management.
...
- **AFIRE (2019, rivaroxaban):** Rivaroxaban monotherapy noninferior to rivaroxaban + antiplatelet for ischemic events and superior for MACE and bleeding in AF + stable CAD. However, used non-standard rivaroxaban dose (15/10 mg; Japanese-approved) and predominantly low-risk patients. Current 2023 AHA/ACC CCD Guideline: **DOAC monotherapy COR 2b/C-LD** after 1 year post-PCI in AF + stable CAD. ([[sources/CCS-AHA-2023]], rating: very high)
- **EPIC-CAD (2024, NEJM; standard-dose edoxaban):** 1,040 patients; AF (CHA₂DS₂-VASc ≥2) + stable CAD (PCI ≥6 months, ACS ≥12 months, or medically managed ≥50% stenosis); mean age 72; mean CHA₂DS₂-VASc 4.3; 12-month follow-up:
  - Net adverse clinical events (NACE): **6.8% vs 16.2%; HR 0.44 (95% CI 0.30–0.65; P<0.001); NNT = 10.6**
  - Major ischemic events: 1.6% vs 1.8%; HR 1.23; NS — statistically similar (trial not powered for this)
  - Major + CRNM bleeding: **4.7% vs 14.2%; HR 0.34 (95% CI 0.22–0.53)**
  - Major bleeding: 1.3% vs 4.5%; HR 0.32 (95% CI 0.14–0.73)
  - Results consistent whether antiplatelet was aspirin or clopidogrel, and regardless of CAD management strategy
  - First RCT to use standard-dose edoxaban and include medically managed (non-revascularized) stable CAD
  - **Limitations:** Open-label; East Asian population only; NACE endpoint biases toward less potent antithrombotic; underpowered for ischemic outcomes. ([[sources/edoxaban-af-cad-nejm-2024]], rating: high)
...
- **IKr modulation (KCNH2 dominant-negative):** KCNH2-G628S adenovirus in pigs (Amit 2010; Soucek 2012) — prolonged atrial APD; reduced AF risk RR 0.44; effect lost at 21 days (adenoviral washout). Validated by 2 independent labs. ([[sources/gene-therapy-arrhythmia-2025]], [[sources/biological-tx-af-hrs-2019]])
...
- **Gap junction restoration (Cx43/Cx40):** Adenoviral GJA1/GJA5 overexpression in pigs (Igarashi 2012; Bikou 2011) — preserved atrial conduction velocity (41 vs 27 cm/s), reduced AF inducibility >80%, +6.6 days sinus rhythm; 2 independent labs. ([[sources/gene-therapy-arrhythmia-2025]], [[sources/biological-tx-af-hrs-2019]])
- **Anti-fibrosis — anti-miR-21 (most replicated):** miR-21 promotes atrial fibrosis via PTEN/Sprouty suppression; anti-miR-21 reduced atrial scar by 5–10% in 4 independent labs (Cardin/Adam/He/Huang; rat/mouse/rabbit models). ([[sources/biological-tx-af-hrs-2019]])
- **Anti-fibrosis — TGF-β blockade:** Dominant-negative TGF-β1 receptor plasmid in dogs (Kunamalla 2016) — fibrosis −8.7%, preserved conduction velocity, shortened AF duration. ACE2 overexpression (adenovirus epicardial; Fan/Zhou ×2 in dogs) — fibrosis −6–9%, reduced AF inducibility. ([[sources/gene-therapy-arrhythmia-2025]], [[sources/biological-tx-af-hrs-2019]])
- **Autonomic modulation:** Gαi C-terminal peptide plasmid (Aistrup 2011) — disrupts IKACh activation by muscarinic receptors; dogs; only study with dose-response relationship. miR-206 suppression (Zhang 2015; lentivirus; dogs) — modulates sympathetic nerve remodelling via SOD1. ([[sources/gene-therapy-arrhythmia-2025]], [[sources/biological-tx-af-hrs-2019]])
- **Anti-apoptosis:** siRNA caspase-3 knockdown (Trappe 2013; plasmid; pigs) — reduced cardiomyocyte apoptosis and delayed sustained AF progression; +4.3 days sinus rhythm. ([[sources/gene-therapy-arrhythmia-2025]], [[sources/biological-tx-af-hrs-2019]])
- **SERCA2a overexpression (AAV9):** Rabbit burst-pacing model; normalises SR Ca²⁺ cycling; reduces triggered activity from Ca²⁺ sparks/NCX. ([[sources/biological-tx-af-hrs-2019]])
- **Key translational barrier:** All 25 studies delivered therapy before AF onset (clinically unrealistic); all used invasive local delivery; 80% used transient adenovirus/plasmid (3–4-day expression); group sizes n=5–16; zero published failures (publication bias). AAV-based durable delivery + multi-target strategies are the path forward. ([[sources/biological-tx-af-hrs-2019]])
...
- **LAAO in high-risk AF — AHA Class IIa vs CLOSURE-AF (NEJM 2026):** The AHA 2023 guideline gives LAAO a Class IIa/B-NR recommendation for AF patients with contraindication to long-term OAC. CLOSURE-AF (n=888; elderly; mean CHA₂DS₂-VASc 5.2, HAS-BLED 3.0; 85% DOAC in medical arm) directly challenges this: LAAO failed noninferiority vs DOACs (P=0.44 for NI; RMST difference −0.36 years; device group numerically worse on all components). Stroke was equal, but major bleeding was higher with LAAO (7.4 vs 6.2/100 pt-yr) and CV death was numerically higher (9.5 vs 7.7/100 pt-yr). The fundamental problem is that periprocedural risk + DAPT-driven early bleeding negates any later stroke prevention benefit in the oldest, sickest patients — the very population LAAO is supposed to help. AHA guideline downgrade is anticipated. ([[sources/laao-closureaf-nejm-2026]], rating: very high)
- **CHAMPION-AF vs CLOSURE-AF — same intervention, opposite NI conclusions (NEJM 2026):** Both trials compared LAAO vs NOAC and were published in the same issue of NEJM 2026, yet reached opposite conclusions on noninferiority. CHAMPION-AF (n=3,000; mean CHA₂DS₂-VASc 3.5; HAS-BLED 1.3; NOAC-eligible; Watchman FLX + 85% NOAC post-implant): **NI demonstrated** for efficacy (P<0.001) + **superiority** for bleeding (HR 0.55; P<0.001). CLOSURE-AF (n=888; mean CHA₂DS₂-VASc 5.2; HAS-BLED 3.0; anticoagulation-unsuitable; multiple devices + predominantly DAPT post-implant): **NI failed** (P=0.44 for NI; device numerically worse). The divergence is mechanistically coherent: (1) risk profile — higher-risk elderly patients accumulate more periprocedural harm relative to baseline thromboembolic risk; (2) post-implant antithrombotic strategy — NOAC post-implant (CHAMPION-AF) eliminates the DAPT-driven early bleeding that negated LAAO benefit in CLOSURE-AF; (3) NI margin structure — absolute (CHAMPION-AF) vs relative (CLOSURE-AF), affecting apparent permissiveness at low event rates. Taken together, these two trials suggest LAAO may benefit lower-to-moderate risk NOAC-eligible patients (CHAMPION-AF population), but is harmful or neutral in the highest-risk anticoagulation-unsuitable elderly AF population (CLOSURE-AF population) — the exact group for whom it was previously most advocated. ([[sources/laao-championaf-nejm-2026]], [[sources/laao-closureaf-nejm-2026]], rating: very high)
- **OPTION vs CLOSURE-AF/CHAMPION-AF — three-trial LAAO NI landscape:** OPTION (NEJM 2025) demonstrated NI of LAAO vs OAC after AF ablation. CHAMPION-AF demonstrated NI + bleeding superiority in NOAC-eligible moderate-risk patients. CLOSURE-AF failed NI in the highest-risk anticoagulation-unsuitable population. Patient risk stratification (CHA₂DS₂-VASc + HAS-BLED) and post-implant antithrombotic protocol are the key determinants of outcome. LAAO may be appropriate in lower-to-moderate-risk patients on post-implant NOAC; it is not a blanket anticoagulation substitute for the highest-risk group. ([[sources/laao-closureaf-nejm-2026]], [[sources/laao-championaf-nejm-2026]], rating: very high)
...
- Related to [[entities/MASLD]]
- Related to [[entities/Obesity]]
...
- Related to [[concepts/Visceral-Adiposity]]
...
- Related to [[concepts/AF-Biological-Therapy]]
...
- Related to [[concepts/DAPT-Strategies]]
- Related to [[concepts/AF-Stable-CAD-Antithrombotic]]
...
- [[sources/biological-tx-af-hrs-2019]]
...
- [[sources/HF-ESC-2021]]
- [[sources/HT-AHA-2025]]
- [[sources/laao-championaf-nejm-2026]]
- [[sources/laao-closureaf-nejm-2026]]
