...
## Epidemiology
- **Prevalence:** ~1:10,000. Average age of symptom onset 7–12 years; ~60% experience first syncope by age 20. ([[sources/channelopathies-jaha-2025]])
- **Mortality:** Up to 50% by age 35 if unrecognised and untreated. ([[sources/channelopathies-jaha-2025]])
- **Misdiagnosis:** Frequently labelled as epilepsy (exercise-triggered syncope with tonic-clonic movements) or vasovagal syncope — diagnostic delay is common. ([[sources/channelopathies-jaha-2025]])
- **De novo vs. inherited:** In the Chang 2025 cohort (n=964), 87 were de novo and 186 inherited among those with inheritance data. De novo patients had a greater proportion of sudden cardiac arrest — genetic testing is warranted even without family history. ([[sources/RYR2-CPVT-CircEP-2025]], rating: very high)

## Genetics
- **RYR2 (CPVT1):** Gain-of-function mutations account for ~50–60% of CPVT; autosomal dominant. ([[sources/channelopathies-jaha-2025]])
- **CASQ2 (CPVT2):** Loss-of-function, second most common (~5%); autosomal recessive — more severe, earlier onset, greater beta-blocker resistance than CPVT1. ([[sources/channelopathies-jaha-2025]])
- **ClinGen Gene-Disease Validity (2026):**
  - *Definitive:* RYR2 (AD, CPVT1); CASQ2 (AR, CPVT2 — also moderate for AD CASQ2); TECRL (AR, CPVT3); TRDN (AR, CPVT5)
  - *Moderate:* CALM1, CALM2, CALM3 (all AD)
  - *Disputed:* PKP2 and KCNJ2 (both disputing 01/20/2021) — should not be attributed as causative without corroborating evidence
  - ANK2 (previously LQT4) has disputed CPVT causation
  - ([[sources/clingen-summary-2026-05-09]], [[sources/arrhythmia-genetics-mgenetik-2025]], rating: high)
- **Variant distribution (Chang 2025, n=964, 263 unique RYR2 variants):** 76.43% of variants reported in ≤3 patients — the vast majority are rare. Top 3 variants: p.G357S (99 patients; inflated by one large multi-generational family), p.R420Q (52), p.R420W (27). ([[sources/RYR2-CPVT-CircEP-2025]])
- **Structural determinants of severity:** Variants in the core solenoid domain (CSol) and channel pore subdomain have earliest onset (median 8 years vs. 11 years overall). EF-hand subdomain variants have latest onset (median 28 years). ([[sources/RYR2-CPVT-CircEP-2025]])
...
- **Median age of onset:** 11 years (IQR 7–14); lower in patients with polymorphic VT (10y vs 13.5y, P<0.001) and syncope (10y vs 14.5y, P<0.001).
...
- **Inter-family heterogeneity:** p.M3978I — every carrier symptomatic; p.G155R — nearly all asymptomatic except one 16-year-old sports-related sudden death. This degree of penetrance variability within the same gene complicates cascade screening and VUS interpretation.
...
- **Web resource:** markslab-cpvtdb.org — publicly queryable database with 3D RYR2 structural visualisation (Mol* Viewer). Allows per-variant outcome queries.
...
- ICD for arrhythmic syncope or bidirectional/PVT despite max BB + flecainide: **Class IIa** (downgraded from Class I in 2022 — reflecting proarrhythmia risk awareness)
...
- **Gene+/phenotype−** (no exercise-induced ectopy on burst exercise stress testing): Competitive sports **reasonable**; discuss prophylactic BB ± flecainide.
- **Asymptomatic CPVT with exercise-induced ectopy:** Competitive sports **can consider** after optimisation of BB + flecainide with stress test normalisation. Adequate suppression = ideally no ectopy; bigeminal PVCs may be acceptable; couplets or NSVT require continued intensification.
- **Previously symptomatic CPVT:** Requires BB + flecainide + possibly LCSD with normalised stress test before competitive sports. Higher-risk; reassess with burst exercise testing every 6–12 months.
- **Serial burst exercise stress testing 1–2 times/year** for longitudinal monitoring of all CPVT athletes.
- **ICD should NOT be implanted solely for competitive sports participation** — adrenergic storm triggered by shocks worsens CPVT arrhythmia; ~5%/year inappropriate shock risk.

See [[concepts/Sports-Cardiology-SDM]] for full SDM framework.

## ESC 2022 Guideline Summary
- Non-selective beta-blockers: **Class I** in all patients with clinical CPVT diagnosis. ([[sources/VA-SCD-ESC-2022]])
- Avoid competitive sports, strenuous exercise, stressful environments: **Class I**.
- ICD + BB + flecainide after aborted CA: **Class I** (NEW 2022 upgrade).
- ICD for arrhythmic syncope or bidirectional/PVT despite max BB + flecainide: **Class IIa** (downgraded from Class I).
- LCSD when flecainide + BB are ineffective, not tolerated, or contraindicated: **Class IIa** (upgraded from IIb).
- Epinephrine/isoproterenol challenge when exercise test not possible: **Class IIb**.
- PES for SCD risk stratification: **NOT recommended (Class III)**.
...
- **AAV9-CASQ2 replacement:** Abolished adrenergically induced VT in CASQ2 KO mice (Denegri 2012); single injection in CASQ2-R33Q knock-in mice achieved >85% arrhythmia reduction sustained ≥1 year (Denegri 2014). ([[sources/gene-therapy-arrhythmia-2025]], rating: high)
- **CASQ2 overexpression in CPVT1:** CASQ2 overexpression suppressed arrhythmias in RYR2-CPVT1 models — a pathway-directed approach to bypass direct RYR2 targeting (Santiago Castillo 2023). Direct RYR2 replacement via AAV is infeasible — gene is ~15,000 nt, far exceeding AAV packaging capacity (~4.7 kb). ([[sources/gene-therapy-arrhythmia-2025]])
- **Allele-specific siRNA silencing (CASQ2-R33Q):** ~60% mRNA/protein reduction; prevented arrhythmias (Bongianino 2017). ([[sources/gene-therapy-arrhythmia-2025]])
