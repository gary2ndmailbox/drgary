...
- **Acetylation:** 8 sites (5 in N-terminal C0-C1 region); confirmed in vivo during ischaemia-reperfusion in mouse hearts. The 40-kDa calpain-degradation fragment is heavily acetylated — acetylation may **promote proteolysis**, contrasting with the protective role of phosphorylation. Functional significance in intact cardiomyocytes remains unclear. ([[sources/mybpc3-gene-2015]], rating: medium)
- **S-glutathiolation:** Three sites (Cys479, 627, 655 in mouse); enhanced in hypertensive mouse models correlating with diastolic dysfunction. In vitro S-glutathiolation increases myofilament Ca²⁺ sensitivity — potentially pathological. Cell-level ablation experiments are needed to confirm cMyBP-C specificity vs. other co-glutathiolated myofilament proteins. ([[sources/mybpc3-gene-2015]])
- **S-nitrosylation:** Cys1270 identified via SNO-resin tandem MS in mouse perfusion experiments; functional role and in vivo occurrence not yet established. ([[sources/mybpc3-gene-2015]])
- **Carbonylation:** Irreversible oxidative modification detected after doxorubicin treatment; potential contributor to chemotherapy-induced cardiac dysfunction. ([[sources/mybpc3-gene-2015]])
