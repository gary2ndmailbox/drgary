...
#### CPAP
- No randomized clinical trials (as of 2018) specifically testing CPAP for AF recurrence. ([[sources/osa-af-jama-2018]])
...
- The SAVE trial (CPAP in moderate-to-severe OSA + documented vascular disease) did not reduce composite cardiovascular outcomes, but AF was not a primary endpoint and rhythm monitoring was inadequate. ([[sources/osa-af-jama-2018]])
...
- **HRS/EHRA/ECAS 2017 Ablation Consensus:** Screen for OSA in AF ablation candidates; CPAP treatment "reasonable to perform" with moderate-quality evidence (Class IIa, Level B-R). ([[sources/osa-af-jama-2018]])
- **AHA 2023 AF Guideline:** Sleep apnea treatment is listed under lifestyle risk factor modification (LRFM) — Class I level of evidence. ([[sources/AF-AHA-2023]], rating: very high)

## Contradictions / Open Questions
- **AHI vs. hypoxemic burden:** AHI is the standard severity metric but may be inferior to nocturnal hypoxemic burden for predicting AF risk and cardiovascular events; no validated alternative metric has been adopted in guidelines. ([[sources/osa-af-jama-2018]])
- **CPAP for AF — RCT evidence gap:** All clinical evidence for CPAP benefit in AF is from non-randomized observational studies; SAVE trial (negative for cardiovascular outcomes in vascular disease + OSA) is a cautionary signal, though AF-specific analysis was inadequate. ([[sources/osa-af-jama-2018]])
