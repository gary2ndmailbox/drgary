---
dg-publish: true
title: "Heart Failure in the Era of Precision Medicine: A Scientific Statement From the American Heart Association"
date_ingested: 2026-04-29
source_type: review article
Citation: "Cresci S, Pereira NL, Ahmad F, Byku M, de las Fuentes L, Lanfear DE, Reilly CM, Owens AT, Wolf MJ; on behalf of the AHA. Heart failure in the era of precision medicine: a scientific statement from the American Heart Association. Circ Genom Precis Med. 2019;12:e000058."
DOI: "https://doi.org/10.1161/HCG.0000000000000058"
tags: [precision-medicine, heart-failure, genomics, pharmacogenomics, omics]
rating: high
raw_path: raw/HF-Precision-Medicine-AHA-2019.md
...
## Wiki Pages Updated
- `wiki/sources/HF-Precision-Medicine-AHA-2019.md` (created)
- `wiki/sourceindex.md` (updated)
- `wiki/wikiindex.md` (updated — new concept pages added)
- `wiki/concepts/Pharmacogenomics-in-HF.md` (created)
- `wiki/concepts/Gut-Microbiome-in-HF.md` (created)
- `wiki/entities/Heart-Failure.md` (updated — precision medicine/omics section)
- `wiki/entities/TTN.md` (updated — mTORC1 + metabolic shift from this source)
- `wiki/entities/LMNA.md` (updated — nuclear stability + MAPK/mTOR pathway)
