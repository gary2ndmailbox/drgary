---
dg-publish: true
title: "Recommendations for the Evaluation of LV Diastolic Function by Echocardiography and for HFpEF Diagnosis: An Update from the ASE (2025)"
...
tags: [echocardiography, diastolic-function, HFpEF, heart-failure, left-atrial-strain]
rating: very high
raw_path: raw/Echo-HFpEF-ASE-2025.md
---
...
- Three primary variables (sinus rhythm patients without severe MR, MS, moderate/severe MAC, AF, HTX, non-cardiac PH, pericardial constriction, LVAD):
  ...
  2. Increased E/e' (septal ≥15, lateral ≥13, or average ≥14)
  3. Increased TR velocity ≥2.8 m/s or PASP ≥35 mmHg
...
- **HFpEF Stepwise Algorithm (Figure 9):**
  ...
  2. Comprehensive echocardiogram → exclude: significant MS/primary MR/AS/AR/TR, significant CAD, non-cardiac PH, cardiac amyloidosis, HCM, pericardial constriction
  3. Apply LAP estimation algorithm (Figure 3)
  4. If LAP elevated → **HFpEF confirmed**
  5. If LAP normal → diastolic exercise echo (or RHC with/without exercise)
  6. If exercise echo positive → **HFpEF confirmed**; if negative → non-cardiac dyspnea
